...
X_val = []
y_val = []
filename_test = os.listdir("D:/PJ/LearnOpenCV/final_test/final_test") 
...
for i in range(len(folder_name)):
    img_dir = "D:/PJ/LearnOpenCV/final_train/final_train/" + str(folder_name[i]) 
...
img_dir = "D:/PJ/LearnOpenCV/final_test/final_test"
